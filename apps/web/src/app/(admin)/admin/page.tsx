...
const statConfig = [
  ...
  { key: "leadOnlyTotal" as const, title: "Lead Total", icon: UserPlus },
  { key: "leadOnlyPending" as const, title: "Lead Pending", icon: Clock },
  { key: "leadOnlyConfirmed" as const, title: "Lead Confirmed", icon: CheckCircle },
